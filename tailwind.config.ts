...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "gold-sm": "0 10px 24px rgba(0, 0, 0, 0.34)",
        "gold-md": "0 10px 30px rgba(0, 0, 0, 0.4)",
        "gold-lg": "0 22px 60px rgba(0, 0, 0, 0.48)",
        "gold-glow": "0 0 20px rgba(212, 255, 0, 0.3)",
      ...
      animation: {
        ...
        "bridge-draw": "bridge-draw 2s ease-out forwards",
      },
    },
  },
