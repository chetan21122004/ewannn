...
const steps = [
  ...
  "Execution - UVAN manages the full mandate on the ground. Regular updates. We handle the complexity.",
  "Ongoing Operations Support - Once established, UVAN continues as your on-ground liaison, operations manager, and language partner.",
];
        ...
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="prose prose-neutral mt-10 max-w-none text-on-light-secondary">
            <p>
              ...
              legal misses how decisions are negotiated in practice - which is precisely why UVAN runs market entry language and operational execution together.
            </p>
