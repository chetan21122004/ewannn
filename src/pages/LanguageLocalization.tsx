...
import { askSohamMessageLink } from "@/components/AskSohamInquiryProvider";
    ...
    >
      ...
      <section id="corridors" className="relative scroll-mt-24 overflow-hidden section-pad theme-section-light sm:px-6">
        ...
        <div className="container relative z-10 mx-auto max-w-6xl">
          ...
          <MarqueeBand
            items={corridors.map((corridor) => `India ↔ ${corridor.market}`)}
            ariaLabel="Language corridors"
            icon={Globe2}
          />
        ...
        <div className="container relative z-10 mx-auto max-w-6xl">
          ...
          >
            ...
            <div className="cta-panel-actions">
              ...
              <Link
                to={askSohamMessageLink.pathname}
                state={askSohamMessageLink.state}
