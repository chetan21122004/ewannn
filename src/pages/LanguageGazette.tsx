...
const LanguageGazette = () => {
  ...
  return (
    ...
    >
      ...
      <section id="latest-issue" className="theme-section-light px-6 py-20">
        ...
        <div className="container mx-auto">
          ...
          <div className="mb-12 flex flex-wrap items-end justify-between gap-5">
            ...
            <div>
              ...
              <h2 className="font-serif text-4xl font-extrabold text-[hsl(var(--brand-navy-950))]">August 2025 Issue</h2>

              <p className="mt-3 text-on-light-secondary">

                Poetry, culture, and essays - fully readable on the web.{" "}

                <Link to="/language-gazette/aug-25" className="font-semibold text-[hsl(var(--brand-purple-700))] hover:underline">
