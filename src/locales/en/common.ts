const enCommon = {
  ...
  footer: {
    ...
    formerName: "(Formerly Ewan Business Solutions)",
    emailLabel: "Email us",
  ...
  home: {
    ...
    sectors: {
      ...
      items: [
        ...
        { name: "Exhibitions & Trade Fairs", code: "06", accent: "cyan" },
    ...
    founders: {
      badge: "The Founders",
      title: "The Founders",
      subtitle: "Leadership that has lived the corridors you are entering.",
  ...
  media: {
    ...
    press: {
      title: "Press Room",
      subtitle: "Published articles, case studies, and press coverage on India-Asia trade and UVAN client work.",
      mediaKit: "Media Kit",
      ...
      items: [
        {
          ...
          desc: "Market research, distributor meetings, interpretation, and on-ground logistics for SHOWA's India entry.",
        },
        {
          date: "2024",
          year: "INSIGHTS",
          title: "Harvesting Asian Prosperity Together",
          desc: "The agricultural sector as a highlight of Indo-Asian collaboration opportunities.",
        },
        {
          date: "2024",
          year: "PRESS",
          title: "Can we truly boycott Chinese products in India?",
          desc: "Business-oriented analysis of India's economic relationship with Chinese goods.",
        },
      ],
    },
  },
