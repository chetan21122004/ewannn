...
const MarketEntryAuditHomeBand = () => (
  ...
  >
    ...
    <div className="container relative z-10 mx-auto max-w-6xl">
      <div className="flex flex-col gap-5 rounded-[1.25rem] border border-[hsl(var(--border-light))] bg-white/[0.88] p-5 shadow-[0_16px_40px_rgba(26,22,51,0.06)] backdrop-blur-sm sm:flex-row sm:items-center sm:justify-between sm:rounded-[1.75rem] sm:p-7 md:p-8">
        <div className="flex items-start gap-4">
          <span className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[hsl(var(--brand-gold-500)/0.15)] text-[hsl(var(--brand-gold-600))]">
        ...
        <Link
          ...
          className="inline-flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-full bg-[hsl(var(--brand-gold-500))] px-6 py-3 text-sm font-semibold text-[hsl(var(--brand-navy-950))] transition hover:brightness-105 sm:w-auto"
        >
