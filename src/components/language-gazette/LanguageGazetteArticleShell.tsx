...
const GazetteArticleSidebar = ({
  ...
  <aside className="hidden lg:block" aria-label="Article details">
    <div className="sticky top-[5.25rem] space-y-4">
      <div className="overflow-hidden rounded-2xl border border-[hsl(var(--border-light))] bg-white shadow-[0_12px_40px_-24px_rgba(26,22,51,0.18)]">
      ...
      <div className="rounded-2xl border border-[hsl(var(--border-light))] bg-white p-5 shadow-sm">
...
const LanguageGazetteArticleShell = ({
  ...
  return (
    ...
    >
      ...
      <article className="bg-[hsl(var(--surface-light-50))] px-4 py-8 sm:px-6 sm:py-10 md:py-14">
        <div className="container mx-auto max-w-6xl">
          <div className="grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_17.5rem] lg:gap-10 xl:grid-cols-[minmax(0,1fr)_20rem] xl:gap-14">
            <div className="min-w-0">
              <div className="mb-6 rounded-2xl border border-[hsl(var(--border-light))] bg-white p-4 shadow-sm lg:hidden">
              ...
              <div className="gazette-article-page relative overflow-hidden rounded-2xl border border-[hsl(var(--brand-navy-950)/0.08)] bg-white px-5 py-8 sm:rounded-[1.25rem] sm:px-8 sm:py-10 md:px-10 md:py-12 lg:px-12">
                <div className={articleBodyClassName}>{children}</div>
                <ArticleServiceLinks />
              </div>

              <div className="mt-6 rounded-2xl border border-[hsl(var(--border-light))] bg-white p-5 shadow-sm lg:hidden">
                <AuthorCard author={author} authorInitial={authorInitial} aboutHref={aboutHref} />
              </div>
            </div>
