...
export const ArticlePullQuote = ({ children, attribution }: { children: ReactNode; attribution?: string }) => (
  <figure className="relative my-12 overflow-hidden rounded-2xl border-l-4 border-[hsl(var(--brand-purple-700))] bg-[hsl(var(--surface-light-50))] px-8 py-10 md:px-12 md:py-12">
    <div className="absolute right-6 top-4 font-serif text-8xl leading-none text-[hsl(var(--brand-purple-700)/0.12)]">&ldquo;</div>
    <blockquote className="relative font-serif text-xl italic leading-relaxed text-on-light md:text-2xl md:leading-relaxed">{children}</blockquote>
    {attribution ? <figcaption className="mt-4 text-sm font-semibold uppercase tracking-[0.16em] text-[hsl(var(--brand-purple-700))]">{attribution}</figcaption> : null}
  </figure>
);

export const ArticleHighlight = ({ children }: { children: ReactNode }) => (
  <div className="my-10 border-l-4 border-[hsl(var(--brand-purple-700))] bg-[hsl(var(--surface-light-50))] px-6 py-6 md:px-8">
