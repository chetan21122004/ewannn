...
const ConsulateLetterGallery = ({
  ...
  className = "grid gap-4 p-6 sm:grid-cols-2 lg:col-span-7 lg:p-8",
          ...
          >
            ...
            >
              <div className="p-3 sm:p-4">
                ...
                />
                <span className="pointer-events-none absolute inset-3 flex items-center justify-center rounded-xl bg-[hsl(var(--brand-navy-950)/0.45)] opacity-0 transition-opacity duration-300 group-hover:opacity-100 group-focus-visible:opacity-100 sm:inset-4">
